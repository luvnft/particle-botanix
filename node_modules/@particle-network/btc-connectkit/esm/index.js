...
// src/hooks/useBTCContractVersion.ts
...
var getBTCAAAddress = (smartAccount, btcAddress, BTCVersion) => __async(void 0, null, function* () {
  var _a;
...
var SignModal = ({ open, onClose, onOpen }) => {
  ...
  return /* @__PURE__ */ jsx8(modal_default, { open, onClose, isDismissable: false, contentClassName: sign_module_default.modalContent, children: /* @__PURE__ */ jsxs5(Fragment3, { children: [
    ...
    /* @__PURE__ */ jsx8("div", { className: sign_module_default.detailsContent + (deserializeResult ? ` ${sign_module_default.fill}` : ""), children: deserializeResult && deserializeResult.map((details, index) => /* @__PURE__ */ jsx8(transactionDetails_default, { details }, `${details.type}-${index}`)) }),
...
var ConnectProvider = ({
  ...
  const [btcContractVersion, _setBTCContractVersion] = useState7(
    ((_a = options.aaOptions.accountContracts["BTC"]) == null ? void 0 : _a[0].version) || "1.0.0"
  );
  const setBTCContractVersion = useCallback7(
    (version) => {
  ...
  const btcContractVersionList = useMemo5(() => {
  ...
  useEffect5(() => {
    ...
    walletEntryPlugin.init(
      ...
      __spreadProps(__spreadValues({}, options.walletOptions), {
        ...
        customStyle: __spreadProps(__spreadValues({}, (_a2 = options.walletOptions) == null ? void 0 : _a2.customStyle), {
          supportChains,
