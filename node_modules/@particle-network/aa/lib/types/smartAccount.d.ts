import type { Account, AccountContract, CreateSessionKeyOptions, FeeQuotesResponse, IEthereumProvider, RequestArguments, SendTransactionParams, SessionDataParams, SessionKey, SmartAccountConfig, Transaction, UserOp, UserOpBundle, UserOpParams } from './types';
export declare class SmartAccount {
    provider: IEthereumProvider;
    private config;
    private connection;
    private smartAccountContract;
    constructor(provider: IEthereumProvider, config: SmartAccountConfig);
    setSmartAccountContract(contract: AccountContract): void;
    private getChainId;
    ...
    sendSignedUserOperation(userOp: UserOp, sessionDataParams?: SessionDataParams): Promise<string>;
    ...
    createSessions(options: CreateSessionKeyOptions[]): Promise<FeeQuotesResponse>;
    validateSession(targetSession: SessionKey, sessions: SessionKey[]): Promise<boolean>;
}
